  ...
  return (
    <section className="bg-white dark:bg-gray-900 pt-14" id="course">
      <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
        ...
        <div className="grid  md:grid-cols-2 md:gap-4 md:grid-rows-6  lg:grid-cols-3 lg:grid-rows-4 lg:gap-6  ">
          ...
          <div className="md:row-span-4 md:col-start-2 md:row-start-3 lg:row-span-3 lg:col-start-2 lg:row-start-2 ">
            <img
              class="w-full rounded-lg"
          ...
          <div className="md:row-span-6 md:col-start-1 md:row-start-5 lg:row-span-2 lg:col-start-3 lg:row-start-1 ">
            <img
              class="w-full rounded-lg"
          ...
          <div className=" md:col-start-2 md:row-start-1 lg:row-span-2 lg:col-start-2 lg:row-start-1 w-full round-lg bg-blue-950">
          ...
          <div className="md:col-start-2 md:row-start-2 lg:row-start-3 bg-blue-950 ">
          ...
          <div className="md:col-start-1 md:row-start-3 lg:col-start-3 lg:row-start-3 bg-blue-950">
            <h3 className="mb-2 text-xl text-center py-6 px-2 font-bold text-white">
          ...
          <div className="md:col-start-2 md:row-start-4 lg:col-start-3 lg:row-start-4 bg-blue-950">
            <h3 className="mb-2 text-xl text-center py-6 px-2 font-bold text-white">
              Ready to make a bold career move even without a degree or prior
              experience in IT?
            </h3>
          </div>
          <div className="md:col-start-2 md:row-start-5 lg:col-start-1 lg:row-start-4 bg-blue-950">
            <h3 className="mb-2 text-xl text-center py-6 px-2 font-bold text-white">
              Feeling trapped in a stagnant job that no longer aligns with your
              goals or vision for the future?
            </h3>
          </div>
          <div className="md:col-start-2 md:row-start-6 lg:col-start-2 lg:row-start-4 bg-blue-950">
