      ...
      <div class="gap-8 items-center text-center py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 sm:py-16 lg:px-6">
        <Slide>
          <div class="mt-4 md:mt-0">
            ...
            <p class="mb-6 font-light leading- font-montserrat  text-gray-500 md:text-lg dark:text-gray-300">
...
AND START EARNING  6-FIGURE IN SALARY
            ...
            <p class="mb-6 font-light leading- font-montserrat text-capitalize text-gray-500 md:text-lg dark:text-gray-300">
