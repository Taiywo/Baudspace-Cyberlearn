      ...
      <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
        ...
        <div class="grid pt-8 gap-5 text-left justify-center border-t text-gray-900 dark:text-white border-gray-200  md:gap-2 md:flex dark:border-gray-700 lg:gap-16 lg:grid-cols-3">
          <Slide direction='left'>
            <div className='w-72 text-center h-[25rem]  dark:bg-gray-800 bg-gray-100 rounded-xl px-5 py-16' >
          ...
          <Fade>
            <div className='w-72 h-[25rem] text-center dark:bg-gray-800 bg-gray-100 rounded-xl px-5 py-16' >
