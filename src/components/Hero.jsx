  ...
  return (
    ...
    <section className="bg-white dark:bg-gray-900 relative" id='home'>
      ...
      <div className="py-8 px-4  relative z-0 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
        ...
        <p className="mb-8 text-lg font-normal  lg:text-xl sm:px-16 xl:px-48 text-gray-400">Embark on a global journey with the Cybersecurity Specialist Program. No tech background, certifications, or degree needed.
</p>
